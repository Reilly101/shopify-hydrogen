...
export function Input({ className = '', type, variant, ...props }) {
  const variants = {
    ...
    minisearch:
      'bg-transparent hidden md:inline-block text-left lg:text-right appearance-none px-0 py-1 focus:ring-transparent placeholder:opacity-20 placeholder:text-[#0f172a]',
  };
